...
<p>Temos duas classes, azul e vermelha, que gostaríamos de separar. Isso pode ser feito tanto pela linha A quanto pela B. Nossa intuição diz que a linha A é melhor do que a B, mas nada garante que a regressão logística ou o <em>perceptron</em> encontrarão a melhor linha separadora. Na verdade, é muito mais provável que eles encontrem uma linha ruim como a B, pois o treinamento normalmente é interrompido quando todos os exemplos do <em>set</em> de treino são classificados corretamente. <strong>Para achar a melhor linha, precisaremos de um outro algoritmo: as máquinas de suporte vetorial.</strong></p>
